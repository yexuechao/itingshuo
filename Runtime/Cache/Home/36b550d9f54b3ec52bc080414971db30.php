...
<ul id="left_link">
 ...
 for($i=0;$i<count($class);$i++){ ?>
	<li><a href="/its/index.php/Home/text/gradeResultText?type_id=<?php echo $type_id; ?>&text_id=<?php echo $text_id; ?>&class_id=<?php echo $class[$i]['class_id']?>&flag=" class="<?php if($i==0){echo 'hover_color';}?> send_flag" target="iFrame2"><?php echo $class[$i]['institute_name'],$class[$i]['class_name']?></a></li>
	<?php
 } ?>
</ul>
