...
<div class="container">
    <div class="top">
        ...
        <!--1是班级，2是个人-->
        <input type="hidden" value="1" id="check_box_value"/>
    </div>
    <div id="iFrame1">
        <iframe name= "iFrame1" class="leftlink" src= "/its/index.php/Home/movie/leftLinkMovie" scrolling= "auto" frameborder= "0"> </iframe>
    </div>
    <div id="iFrame2">
        <iframe name= "iFrame2" class="right" src= "/its/index.php/Home/movie/gradeResultMovie" scrolling= "auto" frameborder= "0"> </iframe>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#check_box_choose").click(function(){
            if($("#check_box_value").val()==1){
                $("#check_box_value").val(2);
//                var href_val=$(".send_flag",document.frames('iFrame2').document).attr("href");
//                href_val=href_val
            }else{
                $("#check_box_value").val(1);
            }
        })
    })
