...
<div class="container">
    ...
    <div id="iFrame1">
        <iframe name= "iFrame1" class="leftlink" src= "/its/index.php/Home/tone/leftLinkTone" scrolling= "auto" frameborder= "0"> </iframe>
    </div>
    <div id="iFrame2">
        <iframe name= "iFrame2" class="right" src= "/its/index.php/Home/tone/gradeResultTone" scrolling= "auto" frameborder= "0"> </iframe>
    </div>
</div>
