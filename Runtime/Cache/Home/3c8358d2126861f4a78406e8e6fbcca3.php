  ...
  <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1.11111px;">
    ...
    <ul class="nav navbar-nav navbar-right" id="menu">
      ...
      <li>
        ...
        <ul>
          <li><a href="/its/index.php/Home/correct/correctIndex/its/index.php/Home/correct/correctIndex"><div class="speech_and_essay"></div></a></li>
        </ul>
      </li>
      ...
      <li>
        <div class="media jumbotron custom_film box">
          <div class="media-body">
            <h2 class="media-heading"><?php echo $course['course_name']?><small>共<?php echo $course['course_num']?>个练习</small></h2>
            <p><?php echo $course['course_introduction']?></p>
            <a href="/its/index.php/Home/tone/senListTeacher?course_id=<?php echo $course['course_id']?>"><div class="button"></div></a>
          </div>
        </div>
      </li>
      <?php
