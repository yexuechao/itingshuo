...
<table width="100%" frame="void" border="1" cellspacing="1" cellpadding="0" bordercolor="#C5C5C5" style="border-collapse:collapse;">
 ...
 foreach($res as $persons){ ?>
        <tr>
            ...
            <td class="col-2"><?php echo $persons['eval_total']?><a href="/its/index.php/Home/tone/person?course_id=<?php echo $course_id; ?>&sentence_id=<?php echo $sentence_id; ?>&user_id=<?php echo $persons['user_id']?>"><img src="<?php echo (HOME_IMG); ?>详细查看.png" title="详细成绩"></a></td>
        </tr>
        <?php
 } ?>
    </tbody>
