...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (INDEX); ?>css/te_index.css">
    <link rel="stylesheet" href="<?php echo (HOME_CSS); ?>te_nav_style.css">
    <link rel="stylesheet" href="<?php echo (INDEX); ?>css/hamburgerMenu.css">
    ...
    <div class="menu">
        ...
        <ul class="hamburger2">
            ...
            <li class="item2" id="cheese2">
                <a href="" title="批改演讲与散文成绩"><img src="<?php echo (INDEX); ?>img/speech_and_essay+.png"></a>
            </li>
...
<script src="<?php echo (INDEX); ?>js/hamburgerMenu.js"></script>
