...
<table width="100%" frame="void" border="1" cellspacing="1" cellpadding="0" bordercolor="#C5C5C5" style="border-collapse:collapse;">
    ...
    <tbody>
        <tr>
            <td class="col-1">谁谁谁</td>
            <td class="not_marked">未批改<a href=""><img src="<?php echo (CORRECT); ?>img/批改.png" title="批改作业"></a></td>
        </tr>
        <tr>
            <td class="col-1">谁谁谁</td>
            <td>已批改<a href=""><img src="<?php echo (CORRECT); ?>img/批改.png" title="批改作业"></a></td>
        </tr>
        <tr>
            <td class="col-1"></td>
            <td></td>
