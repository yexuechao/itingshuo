...
<html lang="zh-CN">
  <head>
    ...
    <link  rel="stylesheet" href="<?php echo (HOME_CSS); ?>te_nav_style.css">
	  <link  rel="stylesheet" href="<?php echo (TONE); ?>css/choose_sentence2.css">
...
<nav class="navbar navbar-default navbar-fixed-top nav_custom" id="menu-wrap">
  ...
  <ol class="custom_navigate list-unstyled">
    <li><a href="/its/index.php/Home/tone/indexTeacher">选择语音语调练习课程</a></li>
    <li>&gt;&gt;</li>
    <li>选择练习句子</li>
  </ol>
      ...
      <li>
        <div class="media jumbotron custom_film box">
          <div class="media-body">
            <h2 class="media-heading"><?php echo $i+1?><small><?php echo $res[$i]['sen_time']?>（句子时长）</small></h2>
            <p><?php echo $res[$i]['content']?></p>
            <p>完成人数：<?php echo $res[$i]["finishNum"]?></p>
            <a href="/its/index.php/Home/tone/checkGradeTone?course_id=<?php echo $res[$i]['course_id'];?>&sentence_id=<?php echo $res[$i]['sentence_id']; ?>"><div class="button"></div></a>
          </div>
        </div>
      </li>
      <?php
