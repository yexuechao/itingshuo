...
//  Embedding flash object ---------------------------------------------------------------------------------------------
  ...
  var appWidth = 60;
  var appHeight = 30;
  var flashvars = {'upload_image': '../../../Public/Home/movie/img/02.png'};
  var params = {wmode:"transparent"};
  var attributes = {id: "recorderApp", name: "recorderApp"};
  //swfobject.createCSS('background-color','red');
  swfobject.embedSWF("../../../Public/Home/js/recorder.swf", "flashcontent", appWidth, appHeight, "11.0.0", "", flashvars, params, attributes);
//  Handling FWR events ------------------------------------------------------------------------------------------------
    ...
    switch (arguments[0]) {
      ...
      case "microphone_connected":
        ...
        FWRecorder.isReady = true;
	  	   FWRecorder.configure(44, 100, 0, 4000);
